...
//      Team team1 = new Team("Blazers", "String location", "String teamType", "String skillLevel", new String[]{"String roster"},
//          "String description",
//          "http://upload.wikimedia.org/wikipedia/en/0/06/Portland_Trail_Blazers_alternate_logo.svg");
//      Team team2 = new Team("Rockets", "String location", "String teamType", "String skillLevel", new String[]{"String roster"},
//          "String description",
...
//    }
    ...
    if (user == null) {
    	user = User.addUser("Admin", adminEmail, adminPassword);
...
//    }
    ...
    if (Court.getCourts().isEmpty()) {
      ...
      Court.addCourt("Salt Lake District Park", null, "public", "outdoor", (long) 8, "full court", "black top",
              "good", true, address8, "It's awesome");

    }

//    if (Team.getTeams().size() == 0) {
//      Team.addTeam(new Team("Kaimuki", "Kaimuki Community Park", "Male", "Recreational", new String[]{"Alex G."}, "",
//          "http://upload.wikimedia.org/wikipedia/en/0/06/Portland_Trail_Blazers_alternate_logo.svg"));
//      Team.addTeam(new Team("Kapolei", "Kapolei Community Park", "Male", "Recreational", new String[]{"Alex G."}, "",
//          "http://cf.juggle-images.com/matte/white/280x280/houston-rockets-script-logo-5-primary.jpg"));
//      Team.addTeam(new Team("Aina-t", "Aina Haina Community Park", "Female", "Recreational", new String[]{"Alex G."},
//          "", "http://www.clker.com/cliparts/e/K/W/w/m/R/yellow-thunder-logo-hi.png"));
//      Team.addTeam(new Team("Manoa", "Manoa Community Park", "Co-ed", "Recreational", new String[]{"Alex G."}, "",
//          "http://content.sportslogos.net/logos/14/1900/full/allfeweaahhiio85qp0l3bhpm.gif"));
//      Team.addTeam(new Team("Makiki", "Makiki Community Park", "Male", "Recreational", new String[]{"Alex G."}, "",
//          "http://www.digindigin.com/blog/wp-content/uploads/2011/03/WARRIORS_LOGO3.png"));
//      Team.addTeam(new Team("Cartwright", "Cartwright Community Park", "Male", "Recreational", new String[]{"Alex G."}, "",
